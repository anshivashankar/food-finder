...
chikfila = Repo.insert!(%Rating{name: "Chik-Fil-A", restaurant_id: "74ngf8", user_id: 1, comment_text: "Superb!", rating_number: 5})
wendys = Repo.insert!(%Rating{name: "Wendy's", restaurant_id: "5345", user_id: 1, comment_text: "Gross!", rating_number: 1})

bostonburgercompany = Repo.insert!(%Rating{name: "Boston Burger Comppany", restaurant_id: "437h", user_id: 2, comment_text: "Wonderful!", rating_number: 4})
